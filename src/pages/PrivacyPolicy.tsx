        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-4 font-medium">
                All business and customer information entered into the App is owned and controlled by you.
            </p>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">4.1 Local Storage (Offline-First)</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              HelaPoint is designed as an offline-first application. Your business data is primarily stored locally on your device, allowing you to operate without internet connectivity.
            </p>

            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">4.2 Cloud Sync</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              When enabled and connected to the internet, data syncs to secure cloud servers to enable multi-device access and backup protection.
              Cloud synchronization is optional and can be disabled within the App.
            </p>

            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">4.3 Security Measures</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
            ...
            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">4.4 Data Retention</h3>
            <p className="text-gray-700 leading-relaxed">
              Your data remains on your device and in cloud backups as long as you use the App. You can delete your data at any time using the data management features within the App or by uninstalling the App.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">5.1 Third-Party Services</h3>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
              ...
              <li>Analytics services (anonymized crash and performance data)</li>
            </ul>
          </section>

          {/* 6. App Permissions */}
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">6. App Permissions</h2>
            <p className="text-gray-700 leading-relaxed mb-4">HelaPoint requests the following device permissions:</p>
            
            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">6.1 Camera</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
            ...
            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">6.2 Storage</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
              <li>Purpose: Save local backups and export data</li>
              <li>Usage: Store business data offline, export backups to device storage</li>
            </ul>

            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">6.3 Bluetooth</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
              <li>Purpose: Connect to receipt printers</li>
              <li>Usage: Only when you configure a Bluetooth printer</li>
            </ul>

            <h3 className="text-lg font-medium text-gray-900 mt-6 mb-2">6.4 Internet</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              To exercise these rights or for any data-related requests, contact us at <a href="mailto:privacy@helapoint.com" className="text-blue-600 hover:underline">privacy@helapoint.com</a>.
            </p>
            <p className="text-gray-700 leading-relaxed mt-4">
